...
(function
  (globalThis){
   ...
   function check_args(loc, pos, len, bstr){
    if(pos < 0){
     var _ax_ = caml_call2(Base[197], loc, cst_pos_0);
     caml_call1(Base[201], _ax_);
    }
    if(len < 0){
     var _ay_ = caml_call2(Base[197], loc, cst_len_0);
     caml_call1(Base[201], _ay_);
    }
    var
    ...
    return caml_call1(Base[201], _aA_);
   }
   ...
   function check_valid_uint16(x, loc){
    ...
    return caml_call1(Base[201], _S_);
   }
      ...
      arch_sixtyfour
       ? function
        (x, loc){
         ...
         return caml_call1(Base[201], _J_);
        }
       : function
        (x, loc){
         if(0 <= x) return 0;
