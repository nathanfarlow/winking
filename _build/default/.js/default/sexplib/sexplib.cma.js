     ...
     for(;;){
      ...
      for(;;){
       ...
       switch(ocaml_lex_state$0){
         case 0:
          caml_call1(found_newline(lexbuf), 0); continue a;
         case 1:
          continue a;
         case 2:
          var
           ...
           for(;;){
            ...
            switch(ocaml_lex_state$2){
              case 0:
               ...
               continue b;
              case 1:
               caml_call2(X[1][4], buf, lexbuf); continue b;
              case 2:
               caml_call2(X[1][4], buf, lexbuf);
               var
              ...
              case 4:
               ...
               var locs$2 = locs$0[2];
               if(locs$2){var locs$0 = locs$2; continue b;}
               break;
              default:
               if(! locs$0)
    ...
    function scan_string(buf, start, lexbuf){
     ...
     for(;;){
      ...
      for(;;){
       ...
       switch(ocaml_lex_state$0){
         case 0:
          caml_call2(X[1][4], buf, lexbuf); return 0;
         case 1:
         ...
         case 3:
          ...
          else if(98 === c) var _n_ = 8; else switch$0 = 1;
          if(switch$0) var _n_ = c;
  ...
  (globalThis){
   ...
   function of_string_bigstring(loc, my_parse, ws_buf, get_len, get_sub, str){
    ...
    if(0 === match[0]){
     ...
     if(0 === match$0[0]){
      var _ak_ = caml_call2(Stdlib_Format[132], _x_, loc);
      return caml_call1(Stdlib[2], _ak_);
     }
     if(! match$0[1]) return sexp;
     var _al_ = caml_call3(Stdlib_Format[132], _y_, loc, parse_pos[4]);
    ...
    var
     ...
     _an_ = caml_call4(Stdlib_Format[132], _z_, loc, cont_state_str, _am_);
   ...
   function gen_load_sexp(my_parse, opt, _aa_, file){
    ...
    try{
     var this_parse$4 = mk_this_parse(0, my_parse), this_parse = this_parse$4;
     for(;;){
      var len = caml_call4(Stdlib[84], ic, buf, 0, buf_len);
      if(0 === len){
       var match = feed_end_of_input(this_parse, cst$3);
       if(0 === match[0])
        var sexp = match[1], sexp$1 = sexp;
       else
        var
         cont_state = match[1],
         _ab_ = caml_call1(Parsexp_Old_parser_cont_state[2], cont_state),
         _ac_ =
           caml_call4(Stdlib_Format[132], _A_, gen_load_sexp_loc, file, _ab_),
       ...
       if(strict){
        ...
        for(;;){
         ...
         if(0 === match$1[0])
          var
           _ad_ = caml_call3(Stdlib_Format[132], _B_, gen_load_sexp_loc, file),
   ...
   function get_conv_exn(file, exc, annot_sexp){
    var
     ...
     col = match[2],
     line = match[1],
     loc = caml_call4(Stdlib_Format[132], _D_, file, line, col),
  ...
  (globalThis){
   ...
   function render_t(putc, anchor, st, t){
    ...
    if(fmt_text){
     ...
     if(runtime.caml_string_notequal(text$0, "")){var fmt_text$0 = text$0; switch$0 = 1;}
    }
    if(! switch$0) var fmt_text$0 = caml_call1(Sexplib_Pre_sexp[22], text);
       ...
       for(;;){
        ...
        lst_ref[1] =
         [0,
          ...
          _t_];
        var _u_ = col - 1 | 0;
        if(1 !== col){var col = _u_; continue;}
        break;
       }
      }
      var _s_ = row - 1 | 0;
      if(1 !== row){var row = _s_; continue;}
      break;
     }
    }
   ...
   function parse(str){
    ...
    for(;;){
     ...
     for(;;){
      ...
      var ix$6 = ix + 1 | 0, index_acc = 0, ix$3 = ix$6;
      for(;;){
...
(function
  (globalThis){
   ...
   function register(exc, exc_name){
    ...
    var _v_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   function register1(make_exc, exc_name, sexp_of_arg1){
    ...
    var _t_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   function register2(make_exc, exc_name, sexp_of_arg1, sexp_of_arg2){
    ...
    var _r_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc, exc_name, sexp_of_arg1, sexp_of_arg2, sexp_of_arg3){
    ...
    var _p_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _n_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _l_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _j_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _h_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _f_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _d_ = caml_call1(Stdlib_Obj[22][1], exc);
   ...
   (make_exc,
    ...
    var _b_ = caml_call1(Stdlib_Obj[22][1], exc);
